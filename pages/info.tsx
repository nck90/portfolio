    ...
    useEffect(() => {
        ...
        async function checkScroll() {
            ...
            if (window.innerHeight / scrollLocation <= 0.7 && contentChange2 === false) {
                ...
                let webLanguage = ['ୱେବ୍', 'rede', 'вэб', 'വെബ്', 'ویب', 'Netz', 'Web', 'сеть', 'वेब', '앱'];
                await wait(200);
            ...
            <div className={styles.main}>
                {content1 && (
                    <>
                        ...
                        <div className={classnames(styles.main_title, styles.ani2, styles.blue)} style={{ margin: '0' }}>고등학생</div>
                        <div className={classnames(styles.main_des2, styles.ani1)} style={{ animationDelay: '.7s' }}>타인을 연대하는</div>
                        <div className={classnames(styles.main_des2, styles.ani1)} style={{ animationDelay: '.6s' }}>타인을 위하는</div>
                        <div className={classnames(styles.main_title, styles.ani3)} style={{ margin: '30px 0 0' }}>개발자에요</div>
                    </>
                )}
            </div>
            <div className={styles.main}>
                {content2 && (
                    <>
                        <div className={classnames(styles.main_title, styles.ani1)} style={{ margin: '0' }}>저는 주로</div>
                        <div className={classnames(styles.main_title, styles.ani2)} style={{ margin: '0' }}><span className={styles.blue}>{content2Text}</span>을 개발해요.</div>
                    </>
                )}
            </div>
            <div className={styles.main}>
                {content3 && (
                    <>
                        ...
                        <div className={classnames(styles.img, styles.ani3)} id={styles.js}></div>
                    </>
                )}
            </div>
            <div className={styles.main}>
                {content4 && (
                    <>
                        ...
                        <div className={classnames(styles.img_container, styles.ani3)}></div>
                        <Link passHref href="/stack">
                            <span className={styles.stack_link}>
                                기술 스택 보기
                            </span>
                        </Link>
                    </>
                    ...
                    <>
                        ...
                        <div className={classnames(styles.project, styles.ani3)}>
                            <div className={styles.project_detail}>
                                <Link passHref href=""><span className={styles.project_name}></span></Link>
                                <div className={styles.project_des}></div>
                            </div>
                        </div>
                    </>
                )}
